...
async def help_about_button(c: Client, cb: CallbackQuery):
    await cb.answer()
    await cb.message.edit(InputMediaPhoto("https://telegra.ph/file/8205571d6ac0c64762e47.jpg"), caption="Fun Module:\n Nothing Much Just Some Little Timepasses", disable_web_page_preview=True,
                          reply_markup=InlineKeyboardMarkup(
            [
                [  # First row
